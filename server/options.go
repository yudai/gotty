...
type Options struct {
	...
	RandomContent       string           `hcl:"random_content" flagName:"random-url-content" flagSName:"rc" flagDescribe:"Set random string directly, should be used with -r" default:""`
