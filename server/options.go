...
type Options struct {
    ...
    EnableSubUrl        bool             `hcl:"enable_sub_url" flagName:"enable-sub-url" flagDescribe:"Enable custom sub URL"`
    CustomSubUrl        string           `hcl:"sub_url" flag-name:"sub-url" flagDescribe:"Custom sub URL to serve at"`
